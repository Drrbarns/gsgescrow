    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        <div className="mb-8 text-center">
          <Code className="mx-auto h-10 w-10 text-primary mb-3" />
          <h1 className="text-2xl font-bold">Seller Badge & Links</h1>
          <p className="text-muted-foreground mt-2">Share these across your social media and bio to build buyer trust.</p>
        </div>
        ...
        <div className="grid gap-6">
          ...
          <Card className="rounded-2xl overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-primary/10 to-transparent">
              <CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5 text-primary" /> Your Trust Badge</CardTitle>
              <CardDescription>Share this page link with buyers to show your verified reputation.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 pt-4">
              <div className="rounded-xl border bg-muted/50 p-4">
                <Label className="text-xs font-medium text-muted-foreground mb-2 block">Badge Page URL</Label>
                <div className="flex items-center gap-2">
                  <Input value={badgeUrl} readOnly className="font-mono text-xs" />
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="gap-2 rounded-full" onClick={() => window.open(badgeUrl, '_blank')}>
          ...
          <Card className="rounded-2xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><LinkIcon className="h-5 w-5 text-primary" /> Quick Buy Link</CardTitle>
              <CardDescription>Buyers click this link to start a transaction with your phone number pre-filled.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center gap-2">
                <Input value={buyUrl} readOnly className="font-mono text-xs" />
          ...
          <Card className="rounded-2xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><Code className="h-5 w-5 text-primary" /> Embed Code</CardTitle>
              <CardDescription>Add this button to your website, blog, or link-in-bio page.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={() => handleCopy(embedCode, 'Embed Code')} className="rounded-full gap-2">
          ...
          <Card className="rounded-2xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><Smartphone className="h-5 w-5 text-primary" /> Bio Text</CardTitle>
              <CardDescription>Add this text to your WhatsApp status, Instagram bio, or TikTok profile.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-xl bg-muted/50 p-4">
                <pre className="text-sm whitespace-pre-wrap">{whatsAppBioLink}</pre>
              </div>
              <Button variant="outline" size="sm" onClick={() => handleCopy(whatsAppBioLink, 'Bio Text')} className="rounded-full gap-2">
          ...
          <Card className="rounded-2xl border-primary/20 bg-primary/5">
            <CardContent className="pt-6">
              <h3 className="font-bold mb-3">Tips for Maximum Trust</h3>
