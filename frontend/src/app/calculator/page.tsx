  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="flex-1">
        ...
        <section className="relative z-20 mx-auto max-w-5xl px-4 -mt-32 pb-24">
          <div className="rounded-3xl bg-white shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden flex flex-col lg:flex-row">
            ...
            {/* Left Side: Inputs */}
            <div className="flex-1 p-8 sm:p-12 lg:border-r border-slate-100">
                ...
                <div className="group relative">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <Input
                      ...
                      placeholder="0.00" 
                      className="h-16 pl-16 text-2xl font-bold rounded-2xl bg-slate-50 border-transparent focus-visible:bg-white focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="mt-10 rounded-2xl bg-amber-50/50 border border-amber-100 p-5 flex gap-4 items-start">
            ...
            <div className="flex-1 bg-slate-50 p-8 sm:p-12 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Buyer Section */}
                <motion.div 
                  className="rounded-2xl bg-white border border-slate-200 p-6 mb-4 shadow-sm"
                  initial={false}
                ...
                >
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-2xl font-bold text-blue-600">GHS <AnimatedNumber value={calc.buyerPays} /></span>
                  </div>
                </motion.div>
                ...
                {/* Seller Section */}
                <motion.div 
                  className="rounded-2xl bg-white border border-slate-200 p-6 mt-4 shadow-sm"
                  initial={false}
                ...
                >
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-2xl font-bold text-green-600">GHS <AnimatedNumber value={calc.sellerReceives} /></span>
                  </div>
                </motion.div>
